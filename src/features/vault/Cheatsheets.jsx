  ...
  return (
    <div className="glass-card-static cheatsheets-container animate-fadeInUp">
      <div className="flex justify-between items-center mb-6 flex-wrap gap-4">
        <div>
          <h2 className="section-title" style={{ fontSize: 'var(--fs-lg)', margin: 0 }}>Cheatsheets & Premium Resources</h2>
          <p style={{ fontSize: 'var(--fs-xs)', color: 'var(--text-secondary)' }}>Quick formula sheets and code command references</p>
        </div>
          ...
          >
            <div>
              <div className="flex justify-between items-center mb-4">
                ...
                <span className="badge badge-purple" style={{ fontSize: '10px' }}>{cs.category}</span>
              </div>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '8px' }}>
                {cs.formulas.map((formula, idx) => {
                  ...
                  return (
                    ...
                    >
                      <code style={{ fontFamily: 'monospace', fontSize: '11px', color: 'var(--accent-cyan)', wordBreak: 'break-all' }}>
                        {formula}
                      </code>
                      <button 
                        className="btn-ghost" 
                        onClick={() => handleCopy(formula, uniqueId)}
                        style={{ padding: '4px', borderRadius: '4px', flexShrink: 0, color: isCopied ? 'var(--accent-emerald)' : 'var(--text-tertiary)' }}
                      >
