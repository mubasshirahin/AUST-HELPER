        ...
        {mode === 'login' ? (
          <form className="auth-form" onSubmit={handleLogin} key="login">
            ...
            <div className="auth-social-buttons">
              <div className="btn btn-social btn-gmail" style={{ padding: 0, overflow: 'hidden', position: 'relative', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                <div ref={googleBtnRef} style={{ minHeight: 40, display: 'flex', alignItems: 'center', justifyContent: 'center' }} />
              </div>
